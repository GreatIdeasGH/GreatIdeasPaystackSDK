...
namespace GreatIdeas.Paystack.API.Resources.Settlements;
...
public partial class SettlementsClient : ISettlementsClient
{
    ...
    public SettlementsClient(HttpClient httpClient)
    {
    ...
    public virtual Task<Response> FetchAsync(int? perPage, int? page)
    {
        return FetchAsync(perPage, page, CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> FetchAsync(int? perPage, int? page, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/settlement?");
        if (perPage != null)
        {
    ...
    public virtual async Task<Response> TransactionAsync(string id, CancellationToken cancellationToken)
    {
        ...
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/settlement/{id}/transaction");
