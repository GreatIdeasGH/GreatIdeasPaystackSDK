...
namespace GreatIdeas.Paystack.API.Resources.Balance;
...
public partial class BalanceClient : IBalanceClient
{
    ...
    public virtual Task<Response> FetchAsync()
    {
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> FetchAsync(CancellationToken cancellationToken)
    {
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> LedgerAsync(int? perPage, int? page, DateTime? from, DateTime? to)
    {
        return LedgerAsync(perPage, page, from, to, CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> LedgerAsync(int? perPage, int? page, DateTime? from, DateTime? to, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/balance/ledger?");
        if (perPage != null)
        {
