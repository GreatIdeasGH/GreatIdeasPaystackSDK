...
public partial class Client : IClient
{
    ...
    public virtual Task<Response> TransferRecipientPutAsync(TransferRecipientUpdate body, string code)
    {
        return TransferRecipientPutAsync(body, code, CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> TransferRecipientPutAsync(TransferRecipientUpdate body, string code, CancellationToken cancellationToken)
    {
        if (code == null)
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> TransferRecipientDeleteAsync(string code)
    {
        return TransferRecipientDeleteAsync(code, CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> TransferRecipientDeleteAsync(string code, CancellationToken cancellationToken)
    {
        if (code == null)
            throw new ArgumentNullException("code");
