...
using GreatIdeas.Paystack.API.Models.TransfersRecipients;

namespace GreatIdeas.Paystack.API.Resources.TransfersRecipients;

[System.CodeDom.Compiler.GeneratedCode("NSwag", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
public partial class TransferrecipientClient : ITransferrecipientClient
{
    private string _baseUrl = "https://api.paystack.co";
    private HttpClient _httpClient;
    private Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

    public TransferrecipientClient(HttpClient httpClient)
    {
    ...
    public virtual Task<Response> CreateAsync(TransferRecipientCreate body)
    {
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> CreateAsync(TransferRecipientCreate body, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/transferrecipient");
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> BulkAsync(TransferRecipientBulk body)
    {
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> BulkAsync(TransferRecipientBulk body, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/transferrecipient/bulk");
    ...
    public virtual async Task<Response> FetchAsync(string code, CancellationToken cancellationToken)
    {
        ...
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/transferrecipient/{code}");
