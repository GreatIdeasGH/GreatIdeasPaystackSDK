...
using GreatIdeas.Paystack.API.Models.Customers;

namespace GreatIdeas.Paystack.API.Resources.Customers;
...
public partial class CustomerClient : ICustomerClient
{
    ...
    public virtual Task<Response> CreateAsync(CustomerCreate body)
    {
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> CreateAsync(CustomerCreate body, CancellationToken cancellationToken)
    {
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> ListAsync(bool? use_cursor, string next, string previous, string from, string to, string perPage, string page)
    {
        return ListAsync(use_cursor, next, previous, from, to, perPage, page, CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> ListAsync(bool? use_cursor, string next, string previous, string from, string to, string perPage, string page, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/customer?");
        if (use_cursor != null)
    ...
    public virtual async Task<Response> FetchAsync(string code, CancellationToken cancellationToken)
    {
        ...
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/customer/{code}");
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> UpdateAsync(CustomerUpdate body, string code)
    {
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> UpdateAsync(CustomerUpdate body, string code, CancellationToken cancellationToken)
    {
        if (code == null)
            throw new ArgumentNullException("code");
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> RiskActionAsync(CustomerRiskAction body)
    {
        return RiskActionAsync(body, CancellationToken.None);
    }
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> RiskActionAsync(CustomerRiskAction body, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/customer/set_risk_action");
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> DeactivateAuthorizationAsync(CustomerDeactivateAuthorization body)
    {
        return DeactivateAuthorizationAsync(body, CancellationToken.None);
    }
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> DeactivateAuthorizationAsync(CustomerDeactivateAuthorization body, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/customer/deactivate_authorization");
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> ValidatteAsync(CustomerValidation body, string code)
    {
        return ValidatteAsync(body, code, CancellationToken.None);
    }
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> ValidatteAsync(CustomerValidation body, string code, CancellationToken cancellationToken)
    {
        if (code == null)
            throw new ArgumentNullException("code");

        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/customer/{code}/identification");
        urlBuilder_.Replace("{code}", Uri.EscapeDataString(ConvertToString(code, System.Globalization.CultureInfo.InvariantCulture)));
