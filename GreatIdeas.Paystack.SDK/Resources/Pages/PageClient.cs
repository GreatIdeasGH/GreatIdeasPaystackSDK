...
using GreatIdeas.Paystack.API.Models.Pages;

namespace GreatIdeas.Paystack.API.Resources.Pages;
...
public partial class PageClient : IPageClient
{
    ...
    public PageClient(HttpClient httpClient)
    {
    ...
    public virtual Task<Response> CreateAsync(PageCreate body)
    {
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> CreateAsync(PageCreate body, CancellationToken cancellationToken)
    {
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> UpdateAsync(PageUpdate body, string id)
    {
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> UpdateAsync(PageUpdate body, string id, CancellationToken cancellationToken)
    {
        if (id == null)
            throw new ArgumentNullException("id");

        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/page/{id}");
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> CheckSlugAvailabilityAsync(string slug)
    {
        return CheckSlugAvailabilityAsync(slug, CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> CheckSlugAvailabilityAsync(string slug, CancellationToken cancellationToken)
    {
        if (slug == null)
            throw new ArgumentNullException("slug");

        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/page/check_slug_availability/{slug}");
        urlBuilder_.Replace("{slug}", Uri.EscapeDataString(ConvertToString(slug, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> AddProductsAsync(PageProduct body, string id)
    {
        return AddProductsAsync(body, id, CancellationToken.None);
    }
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> AddProductsAsync(PageProduct body, string id, CancellationToken cancellationToken)
    {
        if (id == null)
            throw new ArgumentNullException("id");

        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/page/{id}/product");
        urlBuilder_.Replace("{id}", Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
