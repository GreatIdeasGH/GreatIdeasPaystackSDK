...
using GreatIdeas.Paystack.API.Models.Products;

namespace GreatIdeas.Paystack.API.Resources.Product;
...
public partial class ProductClient : IProductClient
{
    ...
    public virtual Task<Response> CreateAsync(ProductCreate body)
    {
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> CreateAsync(ProductCreate body, CancellationToken cancellationToken)
    {
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> ListAsync(int? perPage, int? page, bool? active, DateTime? from, DateTime? to)
    {
        return ListAsync(perPage, page, active, from, to, CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> ListAsync(int? perPage, int? page, bool? active, DateTime? from, DateTime? to, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/product?");
        if (perPage != null)
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> UpdateAsync(ProductUpdate body, string id)
    {
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> UpdateAsync(ProductUpdate body, string id, CancellationToken cancellationToken)
    {
        if (id == null)
            throw new ArgumentNullException("id");
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> DeleteAsync(string id)
    {
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> DeleteAsync(string id, CancellationToken cancellationToken)
    {
        if (id == null)
            throw new ArgumentNullException("id");
