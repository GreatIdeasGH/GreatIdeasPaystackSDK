...
using GreatIdeas.Paystack.API.Models.Splits;

namespace GreatIdeas.Paystack.API.Resources.Split;

[System.CodeDom.Compiler.GeneratedCode("NSwag", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
public partial class SplitClient : ISplitClient
{
    ...
    public virtual Task<Response> CreateAsync(SplitCreate body)
    {
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> CreateAsync(SplitCreate body, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/split");
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> ListAsync(string name, string active, string sort_by, string from, string to, string perPage, string page)
    {
        return ListAsync(name, active, sort_by, from, to, perPage, page, CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> ListAsync(string name, string active, string sort_by, string from, string to, string perPage, string page, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/split?");
        if (name != null)
        ...
        if (sort_by != null)
        {
            urlBuilder_.Append(Uri.EscapeDataString("sort_by") + "=").Append(Uri.EscapeDataString(ConvertToString(sort_by, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
        }
        if (from != null)
        {
    ...
    public virtual async Task<Response> FetchAsync(string id, CancellationToken cancellationToken)
    {
        ...
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/split/{id}");
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> UpdateAsync(SplitUpdate body, string id)
    {
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> UpdateAsync(SplitUpdate body, string id, CancellationToken cancellationToken)
    {
        if (id == null)
            throw new ArgumentNullException("id");
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> AddSubaccountAsync(SplitSubaccounts body, string id)
    {
        return AddSubaccountAsync(body, id, CancellationToken.None);
    }
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> AddSubaccountAsync(SplitSubaccounts body, string id, CancellationToken cancellationToken)
    {
        if (id == null)
            throw new ArgumentNullException("id");

        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/split/{id}/subaccount/add");
        urlBuilder_.Replace("{id}", Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> RemoveSubaccountAsync(SplitSubaccounts body, string id)
    {
        return RemoveSubaccountAsync(body, id, CancellationToken.None);
    }
    ...
    /// <returns>Resource created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> RemoveSubaccountAsync(SplitSubaccounts body, string id, CancellationToken cancellationToken)
    {
        if (id == null)
            throw new ArgumentNullException("id");

        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/split/{id}/subaccount/remove");
        urlBuilder_.Replace("{id}", Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
