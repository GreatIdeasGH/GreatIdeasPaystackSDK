...
namespace GreatIdeas.Paystack.API.Resources.Integration;
...
public partial class IntegrationClient : IIntegrationClient
{
    ...
    public virtual Task<Response> FetchPaymentSessionTimeoutAsync()
    {
        return FetchPaymentSessionTimeoutAsync(CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> FetchPaymentSessionTimeoutAsync(CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/integration/payment_session_timeout");
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual Task<Response> UpdatePaymentSessionTimeoutAsync(object body)
    {
        return UpdatePaymentSessionTimeoutAsync(body, CancellationToken.None);
    }
    ...
    /// <returns>Successful operation</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async Task<Response> UpdatePaymentSessionTimeoutAsync(object body, CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/integration/payment_session_timeout");
