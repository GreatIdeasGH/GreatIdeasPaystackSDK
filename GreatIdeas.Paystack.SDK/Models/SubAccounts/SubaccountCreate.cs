...
public class SubaccountCreate
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonProperty("business_name", Required = Newtonsoft.Json.Required.Always)]
    ...
    /// </summary>
    [Newtonsoft.Json.JsonProperty("settlement_bank", Required = Newtonsoft.Json.Required.Always)]
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    ...
    /// </summary>
    [Newtonsoft.Json.JsonProperty("percentage_charge", Required = Newtonsoft.Json.Required.Always)]
